---
title: "Outpay API Schemas: Checkout, Payment, and Network Fields"
description: Reference the checkout, payment, network, and asset fields returned by Outpay's verified public v1 payment API.
audience:
  - developer
