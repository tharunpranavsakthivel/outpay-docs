---
title: "Outpay v0.1 Beta Release Notes: USDC Checkout Platform"
description: Read the initial Outpay v0.1 Beta release notes for non-custodial USDC checkout, the payment API, merchant tools, webhooks, and known limits.
audience:
  - developer
  - merchant
