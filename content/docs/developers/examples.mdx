---
title: "Outpay Checkout Integration Examples: cURL, Node.js, Next.js"
description: Copy direct HTTP examples for creating Outpay USDC checkouts with cURL, JavaScript, Node.js, Next.js, React, and server-side fetch.
audience:
  - developer
content_type: how-to
