---
title: "Outpay Idempotency: Safe Checkout API Retries"
description: Use idempotency keys with the Outpay checkout creation API to retry requests safely without creating duplicate USDC payment sessions.
audience:
  - developer
content_type: how-to
