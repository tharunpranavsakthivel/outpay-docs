---
title: "Deploy Outpay Payment Infrastructure: Web and Worker Services"
description: Deploy the Outpay web application and payment workers with the required environment, health checks, migrations, and graceful shutdown controls.
audience:
  - internal
content_type: how-to
