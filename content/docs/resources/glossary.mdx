---
title: "Outpay Payments Glossary: Crypto, USDC, Base, and API Terms"
description: Define the crypto payment, USDC, Base blockchain, checkout, API, wallet, webhook, and settlement terms used throughout Outpay Docs.
audience:
  - developer
  - merchant
  - support
